...
All the events created within these groups will be added to your private calendar for manual review on which events will show publicly. To avoid clutter in private schedules you will have the ability to select and deselect which categories you would like to show – this will not effect event clashing as the application will still warn you of clashing events even if the event is in a deselected category. 
